...
/** For debugging */
export type ICoreGQLCardDebugInputType = {
	/** If set, will respond with mock data */
	useMockData: Scalars['Boolean']
	/** URL to a json file containing mock data. If omitted, the default mock data will be returned */
	mockDataUrl?: Maybe<Scalars['String']>
}
...
export type ICoreGQLQuery = {
	...
	/** Gets cards */
	Cards?: Maybe<Array<Maybe<ICoreGQLCardResponseType>>>
...
export type ICoreGQLQueryCardsArgs = {
	...
	locationId?: Maybe<Scalars['ID']>
	organizationId?: Maybe<Scalars['ID']>
	debug?: Maybe<ICoreGQLCardDebugInputType>
}
