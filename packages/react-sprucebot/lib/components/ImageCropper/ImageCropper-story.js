  ...
  (0, _createClass2.default)(ImageCropperExample, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement(_Container.default, {
        ...
        image: (0, _react3.text)('image', 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?ixlib=rb-0.3.5&ixid=eyJhcHBfaWQiOjEyMDd9&s=5d43ec18ec2cf6ff854513b9e8395c1e&auto=format&fit=crop&w=320&h=320&q=80'),
        width: width,
        height: height,
...
stories.add('Static', function () {
  return _react.default.createElement(_Container.default, {
    ...
    isCircular: (0, _react3.boolean)('isCircular', true),
    dropzoneProps: {
      id: 'dropzone',
      onDrop: function onDrop() {
        return console.log('onDrop');
      ...
      isCircular: (0, _react3.boolean)('isCircular', true),
      error: 'Upload an image',
      defaultIcon: (0, _react3.boolean)('isCircular', true) ? _react.default.createElement(AvatarIcon, {
        className: "dropzone__icon"
      }) : _react.default.createElement(ShopIcon, {
        className: "dropzone__icon"
      })
