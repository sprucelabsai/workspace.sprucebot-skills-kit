...
var ConfirmWrapper = _styledComponents2.default.div(_templateObject3);

var ConfirmButton = (0, _styledComponents2.default)(_Button2.default)(_templateObject4);
...
var TimeInput = function (_Component) {
	...
	function TimeInput(props) {
		...
		_this.rcOnOpen = function (open) {
			_this.setState({
				open: true
			});
		};

		_this.rcOnClose = function (open) {
			_this.setState({
				open: false
			});
		};
