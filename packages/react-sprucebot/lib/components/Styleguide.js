...
var Pre = _styledComponents2.default.pre.withConfig({
	displayName: 'Styleguide__Pre',
	componentId: 's138mdcj-0'
})(['font-size:0.8em;text-align:left;width:100%;overflow-x:scroll;background-color:black;color:green;padding:20px;font-family:Courier,\'New Courier\',monospace;tab-size:4;']);

var Dark = _styledComponents2.default.pre.withConfig({
	displayName: 'Styleguide__Dark',
	componentId: 's138mdcj-1'
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(_Input2.default, { label: 'Your Name' }),
						...
						_react2.default.createElement(_Input2.default, { type: 'password', label: 'Password' }),
						_react2.default.createElement(
							_Select2.default,
							{
