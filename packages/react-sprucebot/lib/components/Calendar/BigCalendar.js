...
>>>>>>> a39cc36625869b472dd022b4fcc9c64a1b8b59cf
...
>>>>>>> a39cc36625869b472dd022b4fcc9c64a1b8b59cf
		...
		var _this = _possibleConstructorReturn(
			this,
			(BigCalendar.__proto__ || Object.getPrototypeOf(BigCalendar)).call(
				this,
				props
			)
		)
...
<<<<<<< HEAD
		...
		_this.getDesiredScrollWidth = function() {
			...
			var minWidthOfAllCalendars =
				_this.getDesiredTeammateWrapperWidth() * teammates.length
			...
			widthOfAllCalendars = Math.max(
				minWidthOfAllCalendars,
				widthOfAllCalendars
			)
		...
		_this.getDesiredScrollHeight = function() {
			...
			var firstTeammateWrapper = document.querySelector(
							...
							while (1) {
								switch ((_context.prev = _context.next)) {
									case 0:
										...
										startDate = (0, _moment2.default)(selectedDate).startOf(
											currentView
										)
										endDate = (0, _moment2.default)(selectedDate).endOf(
											currentView
										)
										options = {
											mode: mode,
										...
										_this.setState({
											optionsLoaded: [].concat(
												_toConsumableArray(optionsLoaded),
												[options]
											),
		...
		_this.handlePagerChange = (function() {
			var _ref3 = _asyncToGenerator(
				/*#__PURE__*/ regeneratorRuntime.mark(function _callee2(page) {
		...
		_this.handleChangeView = (function() {
			var _ref4 = _asyncToGenerator(
				/*#__PURE__*/ regeneratorRuntime.mark(function _callee3(idx) {
		...
		_this.timeRange = function() {
			...
			var combinedTimes = [].concat(
				_toConsumableArray(storeSchedule),
				_toConsumableArray(
					adjustedEvents
						.filter(function(event) {
			...
			if (combinedTimes.length !== 0) {
				combinedTimes.forEach(function(event) {
					var start = (0, _moment2.default)(day + ' ' + event.startTime)
						.startOf('hour')
						.subtract(2, 'hour')
					var end = (0, _moment2.default)(day + ' ' + event.endTime)
						.endOf('hour')
						.add(2, 'hour')
				...
				earliest = (0, _moment2.default)(selectedDate)
					.hour(7)
					.minutes(0)
					.seconds(0)

				latest = (0, _moment2.default)(selectedDate)
					.hour(18)
					.minutes(0)
					.seconds(0)
			}
		...
		_this.jumpToTeamMode = _asyncToGenerator(
		...
		_this.jumpToUserMode = _asyncToGenerator(
							...
							switch ((_context5.prev = _context5.next)) {
								...
								case 2:
									...
									new _es6Tween.Tween({
										...
										.to({ y: 0 }, 500)
										.on('update', function(_ref7) {
											var y = _ref7.y

											_this.calendarWrapper.scrollLeft = y
										})
										.easing(_es6Tween.Easing.Quadratic.Out)
										.start()
		...
		_this.slotPropGetter = function(teammate, date) {
			...
			if ((0, _moment2.default)().isBefore(date)) {
		...
		_this.handleScheduleDateSelect = (function() {
			var _ref11 = _asyncToGenerator(
				/*#__PURE__*/ regeneratorRuntime.mark(function _callee6(date) {
					return regeneratorRuntime.wrap(
...
<<<<<<< HEAD
				...
				var currentDate = _moment2.default
					.tz(selectedDate, auth.Location.timezone)
					.format('YYYY-MM-DD HH:mm:ss')
				var today = (0, _moment2.default)()
					.tz(auth.Location.timezone)
					.startOf('day')
				var selectedDateStart = _moment2.default
					.tz(selectedDate, auth.Location.timezone)
					.startOf('day')
...
<<<<<<< HEAD
										...
										className:
											'teammate_calendar__wrapper ' + (idx === 0 ? '' : 'hide'),
										style: {
											...
											_extends(
												{
													...
													views: views,
													events: events
														? _this3.filterEvents(events, teammate)
														: [],
													...
													onSelectEvent: function onSelectEvent(event, e) {
														return _this3.handleClickEvent(
															{
																event: event,
																teammate: teammate,
																view: view,
