...
var DndCalendar = (0, _dragAndDrop2.default)(_reactBigCalendar2.default);
...
var WhiteLabel = (0, _styledComponents2.default)(CalendarComponent).withConfig({
	displayName: 'Calendar__WhiteLabel',
	componentId: 's1m313xp-1'
})(['.rbc-current-time-indicator{background-color:#f85a3e;}.rbc-today{background-color:rgba(96,180,199,0.1);color:#00aac7;}.rbc-event__shift-day,.rbc-event__shift-week{left:0% !important;width:85% !important;border:none !important;border-radius:5px;background-color:#dbeff3;color:#4cadc1;}.rbc-event__break-day,.rbc-event__break-week{left:30% !important;width:70% !important;border:none !important;border-radius:5px;background-color:#c8dadd;color:#387e8d;}.rbc-event__block-day,.rbc-event__block-week{left:15% !important;width:75% !important;border:none !important;border-radius:5px;background-color:#949494;color:#0e2024;}.rbc-event__off-hours-day,.rbc-event__off-hours-week,.rbc-event__closed-day,.rbc-event__closed-week{left:0 !important;right:0 !important;border:none !important;color:rgba(0,0,0,0);background-color:rgba(66,96,126,0.1);}']);
