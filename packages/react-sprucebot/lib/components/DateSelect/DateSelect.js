...
var WhiteLabel = (0, _styledComponents2.default)(Wrapper)(
	_templateObject2,
	function(props) {
...
var NavButton = (0, _styledComponents2.default)(_Icon2.default)(
	_templateObject3
)

var LoadingContainer = _styledComponents2.default.div(
	_templateObject4,
	function(props) {
	...
	function DateSelect() {
		...
		return (
			(_ret = ((_temp = ((_this = _possibleConstructorReturn(
				this,
				(_ref =
					DateSelect.__proto__ || Object.getPrototypeOf(DateSelect)).call.apply(
					_ref,
					[this].concat(args)
				)
			)),
			...
			(_this.isDayBlocked = function(date) {
				...
				var lastDate = (0, _moment2.default)(
			...
			(_this.isOutsideRange = function(date) {
				...
				// console.log('**** IS OUTSIDE RANGE')
				// console.log({ date, allowPastDates })
			...
			(_this.handleDateChange = function(date) {
				var _this$props$onDateSel = _this.props.onDateSelect,
					onDateSelect =
						_this$props$onDateSel === undefined
							? function() {
	...
	_createClass(DateSelect, [
		{
			...
			value: function render() {
				...
				console.log('***** DATE PICKER SELECT')
				console.log({ date, initialVisibleMonth })
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						_reactDates.DayPickerSingleDateController,
						{
							date: date || null,
