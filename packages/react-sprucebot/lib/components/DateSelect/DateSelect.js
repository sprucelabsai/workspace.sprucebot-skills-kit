...
})(['.CalendarDay__selected,.CalendarDay__selected:active,.CalendarDay__selected:hover{background:#00aac7;border:1px solid #00aac7;}.DayPickerNavigation_container{position:absolute;display:flex;justify-content:space-between;width:100%;padding:1em;z-index:2;}.DayPickerNavigation__vertical{background:#fff;bottom:0;left:0;height:52px;}.DayPickerNavigation_button__horizontal{display:flex;justify-content:center;padding:0;border-radius:50%;}.DayPickerNavigation_leftButton__horizontal,.DayPickerNavigation_rightButton__horizontal{height:28px;width:28px;}']);
