	...
	_createClass(DateRangeSelect, [{
		...
		value: function render() {
			...
			return _react2.default.createElement(
				Wrapper,
				{ currentWeek: currentWeek, enableOutsideDays: enableOutsideDays },
