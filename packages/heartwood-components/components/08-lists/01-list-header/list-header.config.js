				...
				actions: [
					{
						...
						icon: '<path fill-rule="evenodd" clip-rule="evenodd" d="M0 0H20V20H0V0Z" fill="none"/><path fill-rule="evenodd" clip-rule="evenodd" d="M16.6666 9.16732H6.52492L11.1833 4.50898L9.99992 3.33398L3.33325 10.0007L9.99992 16.6673L11.1749 15.4923L6.52492 10.834H16.6666V9.16732V9.16732Z"/>',
						class: 'btn-simple btn-small'
					}, {
						icon: '<path fill-rule="evenodd" clip-rule="evenodd" d="M0 0H20V20H0V0Z" fill="none"/><path fill-rule="evenodd" clip-rule="evenodd" d="M9.99992 3.33398L8.82492 4.50898L13.4749 9.16732H3.33325V10.834H13.4749L8.82492 15.4923L9.99992 16.6673L16.6666 10.0007L9.99992 3.33398Z" />',
						class: 'btn-simple btn-small'
					}
				]
			}
