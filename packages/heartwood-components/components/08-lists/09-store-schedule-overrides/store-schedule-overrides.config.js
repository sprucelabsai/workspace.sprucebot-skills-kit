...
module.exports = {
	...
	context: {
		...
		items: [
			{
				title: '<span class="u-ff-proportional-oldstyle">Mon, Sep 3, 2018</span>',
				subtitle: '<span class="u-ff-proportional-oldstyle">12–5pm</span>',
				actions: itemActions
			}, {
				title: '<span class="u-ff-proportional-oldstyle">Wed, Oct 31, 2018</span>',
				subtitle: '<span class="u-ff-proportional-oldstyle">8am–1pm</span>',
				actions: itemActions
			}, {
				title: '<span class="u-ff-proportional-oldstyle">Thu, Nov 22, 2018</span>',
				subtitle: 'Closed',
				actions: itemActions
			}, {
				title: '<span class="u-ff-proportional-oldstyle">Fri, Nov 23, 2018</span>',
				subtitle: '<span class="u-ff-proportional-oldstyle">6am–6pm</span>',
				actions: itemActions
			}, {
				title: '<span class="u-ff-proportional-oldstyle">Wed, Nov 28, 2018</span>',
				subtitle: 'Closed',
				actions: itemActions
			}, {
				title: '<span class="u-ff-proportional-oldstyle">Wed, Dec 25, 2018</span>',
				subtitle: 'Closed',
				actions: itemActions
			}
		]
