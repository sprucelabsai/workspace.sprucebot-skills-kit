		...
		items: [
			{
				title: 'Zoology Days',
				subtitle:
					'<span class="u-ff-proportional-oldstyle">Sep 9–15, 2018</span>',
				actions: itemActions
			},
			{
				title: 'September Salesathon!',
				subtitle:
					'<span class="u-ff-proportional-oldstyle">Sep 17–30, 2018</span>',
				actions: itemActions
			},
			{
				title: 'CSM One-Week Sale',
				subtitle:
					'<span class="u-ff-proportional-oldstyle">Nov 4–10, 2018</span>',
				actions: itemActions
			},
			{
