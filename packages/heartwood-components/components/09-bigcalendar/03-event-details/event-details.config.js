...
const serviceActions = [
	{
		icon: '<path fill-rule="evenodd" clip-rule="evenodd" d="M10.8337 5.83366H9.16699V9.16699H5.83366V10.8337H9.16699V14.167H10.8337V10.8337H14.167V9.16699H10.8337V5.83366V5.83366ZM10.0003 1.66699C5.40033 1.66699 1.66699 5.40033 1.66699 10.0003C1.66699 14.6003 5.40033 18.3337 10.0003 18.3337C14.6003 18.3337 18.3337 14.6003 18.3337 10.0003C18.3337 5.40033 14.6003 1.66699 10.0003 1.66699V1.66699ZM10.0003 16.667C6.32533 16.667 3.33366 13.6753 3.33366 10.0003C3.33366 6.32533 6.32533 3.33366 10.0003 3.33366C13.6753 3.33366 16.667 6.32533 16.667 10.0003C16.667 13.6753 13.6753 16.667 10.0003 16.667V16.667Z"/>'
	}, {
		icon: '<path fill-rule="evenodd" clip-rule="evenodd" d="M11.8707 12.7799L8.77734 13.2224L9.21901 10.1282L17.174 2.1732C17.9062 1.44096 19.0934 1.44096 19.8257 2.1732C20.5579 2.90544 20.5579 4.09263 19.8257 4.82487L11.8707 12.7799Z"  stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M16.29 3.05762L18.9417 5.70928"  stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M16.625 12.875V19.125C16.625 19.8154 16.0654 20.375 15.375 20.375H2.875C2.18464 20.375 1.625 19.8154 1.625 19.125V6.625C1.625 5.93464 2.18464 5.375 2.875 5.375H9.125"  stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>',
		iconClass: 'btn__line-icon'
	}
...
module.exports = {
	...
	context: {
		...
		items: [
			{
				image: 'https://images.unsplash.com/photo-1535441577682-5a7bc0702a7d?ixlib=rb-0.3.5&ixid=eyJhcHBfaWQiOjEyMDd9&s=077e17fb017e1258f3d5d3709729640a&auto=format&fit=crop&w=80&h=80&q=80',
				imageIsAvatar: true,
				width: 40,
				height: 40,
				alt: 'Cooper Moore',
				...
				image: '<path d="M7.875 4.12305H20.375"  stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M7.875 11.623H20.375"  stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M7.875 19.123H20.375"  stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path fill-rule="evenodd" clip-rule="evenodd" d="M1.625 2.37305C1.625 1.95883 1.96079 1.62305 2.375 1.62305H4.625C5.03921 1.62305 5.375 1.95883 5.375 2.37305V4.62305C5.375 5.03726 5.03921 5.37305 4.625 5.37305H2.375C1.96079 5.37305 1.625 5.03726 1.625 4.62305V2.37305Z"  stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path fill-rule="evenodd" clip-rule="evenodd" d="M1.625 9.87305C1.625 9.45883 1.96079 9.12305 2.375 9.12305H4.625C5.03921 9.12305 5.375 9.45883 5.375 9.87305V12.123C5.375 12.5373 5.03921 12.873 4.625 12.873H2.375C1.96079 12.873 1.625 12.5373 1.625 12.123V9.87305Z"  stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path fill-rule="evenodd" clip-rule="evenodd" d="M1.625 17.373C1.625 16.9588 1.96079 16.623 2.375 16.623H4.625C5.03921 16.623 5.375 16.9588 5.375 17.373V19.623C5.375 20.0373 5.03921 20.373 4.625 20.373H2.375C1.96079 20.373 1.625 20.0373 1.625 19.623V17.373Z"  stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>',
				iconClass: 'list-item__icon u-icon__no-fill u-icon__stroke',
				imageIsIcon: true,
				width: 20,
				height: 20,
