				...
				primaries: {
					colors: [
						{ value: '#0076d6', name: 'Primary', variable: '$c-primary' },
						{
							value: '#0099ff',
							name: 'Primary Light',
							variable: '$c-primary-light'
						},
						{
							value: '#005499',
							name: 'Primary Dark',
							variable: '$c-primary-dark'
						}
					]
				},
				greyscale: {
					colors: [
						...
						},
						{
							value: '#f2f4f7',
							name: 'Light Body',
							variable: '$c-light-body',
							textColor: '#242933'
						},
						{
							value: '#d7d9de',
							name: 'Light Body, Light',
							variable: '$c-light-body-light',
							textColor: '#242933'
						},
				...
				ui: {
					colors: [
						...
						{ value: '#e51b3d', name: 'Caution', variable: '$c-caution' },
						{
							value: '#fdd3d4',
							name: 'Caution, Light',
							variable: '$c-caution-light',
							textColor: '#242933'
						},
						{
							value: '#e0edf8',
							name: 'Input Autofill',
							variable: '$c-input-autofill',
							textColor: '#242933'
						}
					]
				}
